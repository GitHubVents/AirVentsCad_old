        ...
        public class Dumper : Product
        {
            ...
            public override void Build()
            {
                ...
                if (TypeOfFlange == "20")
                {
                    ...
                    var newPartPathAsm =
                        $@"{destRootFolder}{DamperDestinationFolder}\{newNameAsm}.SLDASM";
                ...
                if (TypeOfFlange == "30")
                {
                    ...
                    if (isdouble)
                    {
                        ...
                        else
                        {
                            ...
                            newPartPath =
                                $@"{destRootFolder}\{DamperDestinationFolder}\{newName}.SLDPRT";
                            if (GetExistingFile(Path.GetFileNameWithoutExtension(newPartPath), 1, VaultName))
                            {
                                _swApp.IActivateDoc2("10-100", false, 0);
                                swDoc = (ModelDoc2)((IModelDoc2)(_swApp.ActiveDoc));
                    ...
                    newPartPathAsm = $@"{destRootFolder}{DamperDestinationFolder}\{newNameAsm}.SLDASM";
            ...
            internal override string TemplateFolder => @"\Проекты\Blauberg\11 - Регулятор расхода воздуха";
